...
//                Prototype meth = cstInvokeDynamic.getPrototype();
//                CstType definer = cstInvokeDynamic.getBootstrapMethod().getBootstrapMethodRef().getMemberRef().getDefiningClass();
//                meth = meth.withFirstParameter(definer.getClassType());
//                meth = meth.withFirstParameter(cstInvokeDynamic.getType());
//                return opInvokeDynamic(meth);
                return opInvokeDynamic(((CstInvokeDynamic)cst).getPrototype());
            }
    ...
    public static Rop opInvokeDynamic(Prototype meth) {
        return new Rop(RegOps.INVOKE_DYNAMIC, meth.getParameterFrameTypes(), StdTypeList.THROWABLE);
//        return new Rop(RegOps.INVOKE_DYNAMIC, Type.VOID, meth.getParameterFrameTypes(), "test");
    }
