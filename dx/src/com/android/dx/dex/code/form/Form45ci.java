 ...
 * for details.
 */
public final class Form45ci extends InsnFormat {
    /** {@code non-null;} unique instance of this class */
    public static final InsnFormat THE_ONE = new Form45ci();
    ...
    public String insnArgString(DalvInsn insn) {
        ...
        return regListString(regs) + ", " + literalBitsString(value) + ", " + cstString(insn);
    }
