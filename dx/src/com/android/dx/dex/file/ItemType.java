...
public enum ItemType implements ToHuman {
    ...
    TYPE_METHODTYPE_ID_ITEM(        0x0007, "methodtype_id_item"),
    TYPE_METHODHANDLE_ID_ITEM(      0x0008, "methodhandle_id_item"),
    TYPE_INVOKEDYNAMIC_ID_ITEM(     0x0009, "invokedynamic_id_item"),
    TYPE_BSMARGS_LIST_ITEM(         0x0010, "bsmargs_list_item"),
