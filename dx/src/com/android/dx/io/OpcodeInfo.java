...
public final class OpcodeInfo {
	 ...
	 */
	public static final Info SPECIAL_FORMAT = new Info(Opcodes.SPECIAL_FORMAT,
			"<special>", InstructionCodec.FORMAT_00X, IndexType.NONE);

	// TODO: These payload opcodes should be generated by opcode-gen.

	public static final Info PACKED_SWITCH_PAYLOAD = new Info(
			Opcodes.PACKED_SWITCH_PAYLOAD, "packed-switch-payload",
			InstructionCodec.FORMAT_PACKED_SWITCH_PAYLOAD, IndexType.NONE);

	public static final Info SPARSE_SWITCH_PAYLOAD = new Info(
			Opcodes.SPARSE_SWITCH_PAYLOAD, "sparse-switch-payload",
			InstructionCodec.FORMAT_SPARSE_SWITCH_PAYLOAD, IndexType.NONE);

	public static final Info FILL_ARRAY_DATA_PAYLOAD = new Info(
    ...
    public static final Info CONST_METHODTYPE =
        new Info(Opcodes.CONST_METHODTYPE, "const-methodtype",
            InstructionCodec.FORMAT_21C, IndexType.METHODTYPE_REF);

    public static final Info CONST_METHODHANDLE =
        new Info(Opcodes.CONST_METHODHANDLE, "const-methodhandle",
            InstructionCodec.FORMAT_21C, IndexType.METHODHANDLE_REF);
    ...
    public static final Info INVOKE_GENERIC_RANGE =
        new Info(Opcodes.INVOKE_GENERIC_RANGE, "invoke-generic/range",
            InstructionCodec.FORMAT_3RC, IndexType.METHODTYPE_REF);
    ...
    public static final Info INVOKE_EXACT_JUMBO =
        new Info(Opcodes.INVOKE_EXACT_JUMBO, "invoke-exact/jumbo",
            InstructionCodec.FORMAT_5RC, IndexType.METHODTYPE_REF);

    public static final Info INVOKE_GENERIC_JUMBO =
        new Info(Opcodes.INVOKE_GENERIC_JUMBO, "invoke-generic/jumbo",
            InstructionCodec.FORMAT_5RC, IndexType.METHODTYPE_REF);
    ...
    public static final Info CONST_METHODTYPE_JUMBO =
        new Info(Opcodes.CONST_METHODTYPE_JUMBO, "const-methodtype/jumbo",
            InstructionCodec.FORMAT_41C, IndexType.METHODTYPE_REF);

    public static final Info CONST_METHODHANDLE_JUMBO =
        new Info(Opcodes.CONST_METHODHANDLE_JUMBO, "const-methodhandle/jumbo",
            InstructionCodec.FORMAT_41C, IndexType.METHODHANDLE_REF);
